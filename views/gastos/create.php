...
<div class="container-fluid">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title"><b>REGISTRAR NUEVO GASTO</b></h3>
        </div>
        <div class="card-body">
            <form action="<?php echo $URL ?>/app/controllers/gastos/controller_create.php" method="post" id="formulario">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_categoria_gasto" class="form-select" required>
                                        ...
                                        ?>
                                            <option value="<?php echo $categoria['id_categoria_gasto'] ?>"><?php echo $categoria['nombre'] ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion" class="form-control" rows="3" placeholder="Ingrese la descripción del gasto..." required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <center>
                    <button class="btn btn-primary" type="submit">
                        <i class="bi bi-floppy-fill"></i> Registrar Gasto
                    </button>
