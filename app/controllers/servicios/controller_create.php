...
$sql = "INSERT INTO tb_servicios(nombre_servicio,precio, acumula_puntos, puntos_para_gratis,descripcion,imagen,fyh_creacion) 
VALUES('$nombre_servicio','$precio', '$acumula_puntos','$puntos','$descripcion','$imagen','$fyh_creacion')";
